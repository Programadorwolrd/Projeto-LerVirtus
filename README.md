O projeto Lervirtus tem como objetivo desenvolver um programa que calcula a quantidade de páginas que um usuário deve ler por dia para terminar um livro em um determinado período de tempo.
